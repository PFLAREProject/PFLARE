...
# ======================================================
# 5. INITIAL CONDITION (GAUSSIAN PULSE)
# ======================================================
...
if PETSc.COMM_WORLD.getRank() == 0:
    ...
    plt.legend()
    plt.grid(True)
    plt.title("1D Slice (Gaussian Pulse → Shock)")
    plt.xlabel("x")
    ...
    plt.title("2D Inviscid Burgers (Gaussian IC)")
    plt.xlabel("x")
    plt.ylabel("y")
    ...
    ax.set_title("3D Surface (Gaussian IC)")
    ax.set_zlim(-0.1, 1.1)
