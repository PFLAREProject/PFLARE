...
Please compile PETSc directly from the source code, as PFLARE requires access to some of the PETSc types only available in the source. If you wish to run on GPUs with Kokkos (recommended) you must use the latest release of PETSc (3.23).
